...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        injuries = [
            Injury(type_of_injury="Ankle Break"),
            Injury(type_of_injury="Ankle Sprain"),
            Injury(type_of_injury="Ankle Tear"),
            Injury(type_of_injury="Ankle Dislocation"),
            Injury(type_of_injury="Ankle Fracture"),

            Injury(type_of_injury="Knee Break"),
            Injury(type_of_injury="Knee Sprain"),
            Injury(type_of_injury="Knee Tear"),
            Injury(type_of_injury="Knee Dislocation"),
            Injury(type_of_injury="Knee Fracture"),

            Injury(type_of_injury="Hip Break"),
            Injury(type_of_injury="Hip Sprain"),
            Injury(type_of_injury="Hip Tear"),
            Injury(type_of_injury="Hip Dislocation"),
            Injury(type_of_injury="Hip Fracture"),

            Injury(type_of_injury="Wrist Break"),
            Injury(type_of_injury="Wrist Sprain"),
            Injury(type_of_injury="Wrist Tear"),
            Injury(type_of_injury="Wrist Dislocation"),
            Injury(type_of_injury="Wrist Fracture"),

            Injury(type_of_injury="Elbow Break"),
            Injury(type_of_injury="Elbow Sprain"),
            Injury(type_of_injury="Elbow Tear"),
            Injury(type_of_injury="Elbow Dislocation"),
            Injury(type_of_injury="Elbow Fracture"),

            Injury(type_of_injury="Shoulder Break"),
            Injury(type_of_injury="Shoulder Sprain"),
            Injury(type_of_injury="Shoulder Tear"),
            Injury(type_of_injury="Shoulder Dislocation"),
            Injury(type_of_injury="Shoulder Fracture"),   
        ]
